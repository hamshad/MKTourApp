class ApiConstants {
  ...
  // static const String socketUrl = 'http://192.168.1.16:5001';
  // Live API socket URL
  ...
  static const String requestUserPhoneUpdateOtp =
      '$baseUrl/users/request-phone-update-otp';
  ...
  static const String requestDriverPhoneUpdateOtp =
      '$baseUrl/drivers/request-phone-update-otp';
  ...
  static String stopArrive(String id) => '$baseUrl/rides/$id/stop/arrive';
  static String stopResume(String id) => '$baseUrl/rides/$id/stop/resume';
  ...
  static const String scheduledPool = '$baseUrl/rides/scheduled/pool';
  static const String driverScheduledRides = '$baseUrl/rides/scheduled/driver';
